...
// Generates and displays a report of all sales for the current day.
...
// Get today's sales
$today = date('Y-m-d');
$stmt = $conn->prepare("SELECT s.id, s.sale_date, u.username, s.total FROM sales s LEFT JOIN users u ON s.user_id = u.id WHERE DATE(s.sale_date)=?");
...
<table border="1" cellpadding="5" cellspacing="0">
    ...
    <?php else: ?>
        <tr><td colspan="4">No sales for today.</td></tr>
    <?php endif; ?>
</table>
